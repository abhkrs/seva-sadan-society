...
<section class="pad">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 <?php echo $i%2 ===0 ? 'ps-lg-4 ps-xl-5 order-lg-2' : 'pe-lg-4 pe-xl-5'; $i++; ?>">
                ...
                <div class="row pt-3">
                    <div class="col-6 px-2">
                        <img src="<?php echo esc_url(get_sub_field('image_1')['url']); ?>"
                            alt="<?php echo esc_attr(get_sub_field('image_1')['alt']); ?>"
                            class="img-fluid animate-this rounded-3">
                    </div>
                    <div class="col-6 px-2">
            ...
            <div class="col-lg-6 d-flex flex-column justify-content-center">
                ...
                <h3 class="fs-5 fw-bold">Amenities:</h3>
